 ...
 * laptop, a phone, or a CI box that has never seen a face.
 *
 * It is deliberately a plain state holder, not a ViewModel: keeping it in
 * `commonMain` means the exact same logic backs the Android and iOS apps. One
 * brain, two faces.
 */
class PlaygroundState(private val scope: CoroutineScope) {
    ...
    /** Build and send one tutorial step. The Back/Next buttons recurse into here. */
